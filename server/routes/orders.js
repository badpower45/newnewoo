...
router.post('/', validate(orderSchema), async (req, res) => {
    ...
    try {
        ...
        const insertSql = `
            INSERT INTO orders (
                user_id, branch_id, total, items, status, payment_method, shipping_info, order_code, unavailable_items, unavailable_contact_method
            )
